...
# 2 "E:\\win_code_git\\alist_ACTIVITY\\RMsmartCar\\main\\main.ino" 2
# 3 "E:\\win_code_git\\alist_ACTIVITY\\RMsmartCar\\main\\main.ino" 2
# 4 "E:\\win_code_git\\alist_ACTIVITY\\RMsmartCar\\main\\main.ino" 2
/* -------------------------------------------------------------------------- */
/*                                    基本定义                                    */
/* -------------------------------------------------------------------------- */
...
void forward()
{
    digitalWrite(motor1Pin1, 0x1);
    digitalWrite(motor1Pin2, 0x0);
    digitalWrite(motor2Pin1, 0x1);
    digitalWrite(motor2Pin2, 0x0);
}
...
void backward()
{
    ...
    digitalWrite(motor1Pin2, 0x1);
    digitalWrite(motor2Pin1, 0x0);
    digitalWrite(motor2Pin2, 0x1);
}
